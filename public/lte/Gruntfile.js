...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both lte.css and lte.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/AdminLTE.css": "build/less/lte.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/AdminLTE.min.css": "build/less/lte.less",
          // Skins minified
