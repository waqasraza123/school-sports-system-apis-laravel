                                ...
                                <div class="col-md-6">
                                    <div class="form-group-sm">
                                        <div class="col-s-3">
                                            ...
                                            <input type="color" name="school_color" class="form-control" id="school-color">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group-sm">
                                        <div class="col-s-3">
                                            ...
                                            <input type="color" name="school_color2" class="form-control" id="school-color2">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group-sm">
                                        <div class="col-s-3">
                                            ...
                                            <input type="color" name="school_color3" class="form-control" id="school-color3">
                                        </div>
                                    </div>
                                </div>
