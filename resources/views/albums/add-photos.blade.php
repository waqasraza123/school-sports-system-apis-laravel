            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-10">
                    ...
                    <div class="jumbotron how-to-create" >
                        ...
                        {!! Form::open(['url' => route('upload-photos-post'), 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        {{--{!! Form::submit('Upload', ['class' => 'btn btn-sm', 'style' => 'margin: 0 auto; text-align:center']) !!}--}}
...
@section('footer')
    ...
    @include('albums.partials.footer-script')
@endsection